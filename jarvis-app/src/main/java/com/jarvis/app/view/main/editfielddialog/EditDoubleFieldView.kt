...
import com.jarvis.app.view.main.DoubleFieldItemViewModel
...
class EditDoubleFieldView(
    ...
    private val textInput =
        container.findViewById<TextInputLayout>(R.id.edit_text_input_layout)
            .apply {
                hint = item.hint
                editText?.inputType = INPUT_TYPE_DOUBLE
    ...
    override fun isValid(): Boolean {
        val errorMessage = item.validate(value as Double)
    ...
    companion object {
        private const val INPUT_TYPE_DOUBLE =
